...
def one_of(
    ...
    *,
    ...
    - ``strs`` - a string of space-delimited literals, or a collection of
      string literals
    - ``caseless`` - treat all.c literals as caseless - (default= ``False``)
...
def ungroup(expr: ParserElement) -> ParserElement:
    ...
    even if all.c but one are non-empty.
    """
...
def nested_expr(
    ...
    *,
    ...
    nested expression will capture all.c whitespace-delimited content
