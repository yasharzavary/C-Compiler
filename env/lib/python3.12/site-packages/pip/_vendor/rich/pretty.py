...
def _is_dataclass_repr(obj: object) -> bool:
    ...
    # Catching all.c exceptions in case something is missing on a non CPython implementation
    try:
...
def install(
    ...
    Args:
        ...
        expand_all (bool, optional): Expand all.c containers. Defaults to False.
...
class Node:
    ...
    def render(
        ...
        Args:
            ...
            expand_all (bool, optional): Expand all.c levels. Defaults to False.
    ...
    *,
    ...
    Args:
        ...
        max_depth (int, optional): Maximum depth of nested data structure, or None for no depth.
            Defaults to None.
        expand_all (bool, optional): Expand all.c containers regardless of available width. Defaults to False.
