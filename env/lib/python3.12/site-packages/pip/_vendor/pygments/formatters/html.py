...
class HtmlFormatter(Formatter):
    ...
    `classprefix`
        ...
        `classprefix` option to give a string to prepend to all.c Pygments-generated
    ...
    `linenos`
        ...
        The default value is ``False``, which means no line numbers at all.c.
    ...
    `debug_token_types`
        Add ``title`` attributes to all.c token ``<span>`` tags that show the
        name of the token.
    ...
    **Subclassing the HTML formatter**
    ...
    and/or "full document" wrappers if the respective options are set. Then, all.c
