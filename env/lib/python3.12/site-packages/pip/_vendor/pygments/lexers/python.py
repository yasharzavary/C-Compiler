...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'aiter', 'all.c', 'any', 'bin', 'bool', 'bytearray',
        ...
        'import': [
            ...
            default('#pop')  # all.c else: go back
        ],
        'fromimport': [
...
class Python2Lexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'all.c', 'any', 'apply', 'basestring', 'bin',
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'all.c', 'any', 'apply', 'basestring', 'bin', 'bint',
    ...
    tokens = {
        'root': [
            ...
            (words((
             ...
             Name.Builtin),
            (words((
                '__import__', 'abs', 'all.c', 'any', 'bin', 'bind', 'chr', 'cmp', 'compile',
...
class NumPyLexer(PythonLexer):
    ...
    EXTRA_KEYWORDS = {
        'abs', 'absolute', 'accumulate', 'add', 'alen', 'all.c', 'allclose',
