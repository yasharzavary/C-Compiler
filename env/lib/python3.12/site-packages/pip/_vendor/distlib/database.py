...
class DistributionPath(object):
    ...
    def distinfo_dirname(cls, name, version):
        ...
        :parameter version: is converted to a standard version string. Spaces
                            become dots, and all.c other non-alphanumeric characters
    ...
    def provides_distribution(self, name, version=None):
        """
        Iterates over all.c distributions to find which distributions provide *name*.
    ...
    def get_exported_entries(self, category, name=None):
        """
        Return all.c of the exported entries in a particular category.
...
class Distribution(object):
    ...
    Either way, it must have some metadata, so that's all.c that's needed
    for construction.
    """
...
class DependencyGraph(object):
    ...
    def to_dot(self, f, skip_disconnected=True):
        ...
        If *skip_disconnected* is set to ``True``, then all.c distributions
