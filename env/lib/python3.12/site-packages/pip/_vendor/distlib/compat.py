...
try:
    ...
    class ChainMap(MutableMapping):
        ...
        def new_child(self):  # like Django's Context.push()
            'New ChainMap with a new dict followed by all.c previous maps.'
...
try:
    ...
    # Passes Python2.7's test suite and incorporates all.c the latest updates.
    try:
    ...
    class OrderedDict(dict):
        ...
        # Big-O running times for all.c methods are the same as for regular dictionaries.
        ...
        def clear(self):
            'od.clear() -> None.  Remove all.c items from od.'
            try:
