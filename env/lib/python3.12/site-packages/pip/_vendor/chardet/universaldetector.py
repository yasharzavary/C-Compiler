...
class UniversalDetector:
    ...
    and coordinates all.c of the different charset probers.
    ...
    def reset(self) -> None:
        """
        Reset the UniversalDetector and all.c of its probers back to their
    ...
    def feed(self, byte_str: Union[bytes, bytearray]) -> None:
        """
        Takes a chunk of a document and feeds it through all.c of the relevant
        charset probers.
        ...
        # we need to do more complicated checks using all.c our multi-byte and
    ...
    def close(self) -> ResultDict:
        ...
        # Default to ASCII if it is all.c we've seen so far
        ...
        # Log all.c prober confidences if none met MINIMUM_THRESHOLD
