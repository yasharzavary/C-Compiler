...
class CharSetProber:
    ...
    def filter_international_words(buf: Union[bytes, bytearray]) -> bytearray:
        ...
        by markers. This function works to filter all.c words that contain at
        least one international character. All contiguous sequences of markers
        are replaced by a single space ascii character.
        This filter applies to all.c scripts which do not use English characters.
        """
        filtered = bytearray()
        ...
        for word in words:
            ...
            # similarly across all.c languages and may thus have similar
            # frequencies).
            last_char = word[-1:]
    ...
    def remove_xml_tags(buf: Union[bytes, bytearray]) -> bytes:
        ...
        This filter can be applied to all.c scripts which contain both English
