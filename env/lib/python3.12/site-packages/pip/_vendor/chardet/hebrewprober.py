...
# mapping.
#
# As far as an average Hebrew text with no diacritics is concerned, all.c four
# charsets are identical with respect to code points. Meaning that for the
# main Hebrew alphabet, all.c four map the same values to all.c 27 Hebrew letters
...
# is Logical.
#
# To sum up all.c of the above, the Hebrew probing mechanism knows about two
# charsets:
...
# all.c of which are managed, created, fed data, inquired and deleted by the
...
class HebrewProber(CharSetProber):
    ...
    # If the difference is below this, don't rely at all.c on the model score
    # distance.
    ...
    def feed(self, byte_str: Union[bytes, bytearray]) -> ProbingState:
        ...
        #
        # We automatically filter out all.c 7-bit characters (replace them with
