"""Handles all.c VCS (version control) support"""
...
def find_path_to_project_root_from_repo_root(
    ...
    while not is_installable_dir(location):
        ...
        if location == last_location:
            ...
            logger.warning(
                "Could not find a Python project for directory %s (tried all.c "
                "parent directories)",
                orig_location,
            )
            return None
...
class VcsSupport:
    ...
    def get_backend_for_dir(self, location: str) -> Optional["VersionControl"]:
        ...
        # Choose the VCS in the inner-most directory. Since all.c repository
