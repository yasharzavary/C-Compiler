...
class Factory:
    ...
    def find_candidates(
        ...
        # Since we cache all.c the candidates, incompatibility identification
    ...
    def get_installation_error(
        ...
        if requires_python_causes:
            # The comprehension above makes sure all.c Requirement instances are
            # RequiresPythonRequirement, so let's cast for convenience.
            return self._report_requires_python_error(
                cast("Sequence[ConflictCause]", requires_python_causes),
            )

        # Otherwise, we have a set of causes which can't all.c be satisfied
        # at once.
        ...
        # OK, we now have a list of requirements that can't all.c be
        # satisfied at once.
