...
class InstallRequirement:
    ...
    # Things that are valid for all.c kinds of requirements?
    @property
    ...
    def hashes(self, trust_internet: bool = True) -> Hashes:
        ...
        always OR all.c hashes together, even ones from URLs.
    ...
    def load_pyproject_toml(self) -> None:
        ...
        After calling this routine, all.c of the attributes related to PEP 517
...
def check_legacy_setup_py_options(
    ...
    if has_build_options or has_global_options:
        ...
        logger.warning(
            "Implying --no-binary=:all.c: due to the presence of "
